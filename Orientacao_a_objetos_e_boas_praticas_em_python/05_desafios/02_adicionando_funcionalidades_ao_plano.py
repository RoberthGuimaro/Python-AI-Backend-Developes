...
# TODO: Crie um método 'mensagem_personalizada' para gerar uma mensagem personalizada com base no saldo: 
    def mensagem_personalizada(self):
        if self.saldo > 0:
            return "Você ainda possuí saldo disponível."
        else:
            return "Seu saldo está zerado. Faça uma recarga para poder utilizar nossos serviços."
...
# TODO: Crie um método para verificar o saldo do usuário e gerar uma mensagem personalizada:
    def __repr__(self):
        mensagem = self.plano.verificar_saldo()
        return f"{mensagem}"
